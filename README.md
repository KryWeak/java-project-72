# Java Project 72 — Анализатор страниц
...
## Анализатор страниц — инструмент для анализа веб-страниц: собирает мета-данные, структуру и производительность сайтов, помогая оптимизировать контент и SEO.
